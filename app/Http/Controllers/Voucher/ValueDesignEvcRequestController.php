...
final class ValueDesignEvcRequestController extends Controller
{
    protected string $baseUrl = 'https://at.valuedesign.co.in/distributor/';

    public function __construct(private readonly VDWebApiService $vdWeb) {}
    ...
    public function store(Request $request)
    {
        ...
        $validated['order_id'] = Str::upper(Str::random(20));
        $validated['receipt_no'] = Str::upper(Str::random(12));
        $validated['req_id'] = Str::upper(Str::random(16));
