...
final class KGenOrderController extends Controller
{
    ...
    public function placeOrder(Request $request)
    {
        ...
        $data = $response->json();
        $dproductprice = $data['totalAmount'] ?? 0;
        ...
        switch ($data['status'] ?? null) {
            ...
            case 'PROCESSED':
                ...
                Log::info('KGen order placed', ['status' => $pendingOrder->status, 'order_id' => $pendingOrder->id]);
