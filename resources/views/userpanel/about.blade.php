...
@section('content')
    <div class="about-wrapper pb-7 pt-7">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="display3-size fw-300 open-font lh-2 mt-0">Welcome to Amazepays, your one-stop destination for
                        gift vouchers and digital gift cards!</h2>
                </div>
                <div class="col-lg-12 mt-5">
                    <h4 class="text-grey-900 fw-600 font-xl ls-2">WHAT WE DO</h4>
                    <h4 class="font-xsss lh-24 fw-500 text-grey-500 mt-4"> At Amazepays, we believe in making gifting a
