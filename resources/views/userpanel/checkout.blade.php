                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="billing_country" id="billing_country" class="form-control billingFormInput">
                                                <!-- Default option -->
                                                <option value="">Select a country</option>
                                                <!-- India as the first option and selected by default -->
                                                <option value="India" {{ old('billing_country', Auth::user()->billing_country ?? 'India') == 'India' ? 'selected' : '' }}>India</option>
                                                <!-- Other countries -->
