                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="row order-data">
                                                ...
                                                <div class="col-md-6 col-sm-4 col-xp-6">
                                                    <a href="{{ $product ? route('get-product-by-slug', ['slug' => $product->url]) : '#' }}"
                                            ...
                                            <div class="row cart-item-record">
                                                <div class="col-md-5 col-sm-4 col-xs-12">
                                                    <img class="cart-coupan-img"
                                                        src="{{ $product?->display_image_url ?? URL::asset('/images/hamburger.jpg') }}"
                                                        alt="Avatar" style="width:100%;">
                                                </div>
                                                <div class="col-md-7 col-sm-4 col-xs-12">
                                                    <span class="product-name mont-font">{{ $product?->name ?? __('Gift card') }}</span>
                                                    <div class="row item-qty-subtotal">
                                                        <div class="col-12">
                                                            <span>Denomination: ₹{{ $order->denomination }}</span>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div class="row total-amount justify-content-center">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-4 col-xs-3 amount mont-font">
                                                        <span>₹{{ $order->grand_payable_amount }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-4 col-xs-3 amount mont-font">
                                                        <span>₹{{ $order->amount_payable_after_discount ?? $order->grand_payable_amount }}</span>
                                                    </div>
...
<!--<form method="POST" action="{{ route('payment.netbnk') }}">
    @csrf
    <input type="hidden" name="payable_amount" value="{{ $order->amount_payable_after_discount }}">
