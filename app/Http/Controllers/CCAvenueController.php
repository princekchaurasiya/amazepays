...
class CCAvenueController extends Controller
{
    ...
    protected $isSuccessful = false; // Class property to track success status
    ...
    protected function storeCcAvenueData($qsOrderDetails, $ccAvenueCollectedDataArray)
    {
        ...
        $newCcAvenueOrder->fill([
            'user_id' => $qsOrderDetails->user_id,
    ...
    protected function updateQsOrder($sessionId, Request $request)
    {
        try {
            ...
            $updateData = [
                ...
                'gst_number' => $request->billing_gst_number ?: 'Unregistered',
