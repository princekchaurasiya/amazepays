...
return [
    ...
    'comapny_bank_name' => env('COMPANY_BANK_NAME', 'KOTAK BANK'),
    'comapny_email' => env('COMPANY_EMAIL', 'support@amazepay.in'),
    ...
    'comapny_email' =>  env('COMPANY_WEBSITE', 'samsher@amazepays.in'),
    'comapny_contact_no' =>  env('COMPANY_CONTACT_NO', '9988776655'),
