                ...
                <div class="col-lg-3">
                    <div class="dashboard-nav bg-white rounded-lg shadow-xs">
                        ...
                        <ul class="dash-menu-ul">
                            ...
                            <li class="d-block rounded-lg"><a href="{{ route('myOrder') }}"><i
                            ...
                            {{-- <div class="card d-none-md w-100 mt-3 shadow-none pt-0 border-0">
                                <div class="card-body b-r-15 overflow-hidden position-relative bg-lightblue rounded-lg p-4 z-index bg-no-repeat bg-image-right"
                                    style="background-image: url(https://via.placeholder.com/300x300.png); ">
                                    <h3 class="text-grey-700 font-md lh-2 fw-900 mb-3">Online <br>Recharge</h3>
                                    <a href="#"
                                        class="btn b-r-15 bg-white shadow-lg fw-700 font-xssss lh-30 w100 text-center text-grey-900">Buy
                                        Now</a>
                                </div>
                            </div> --}}
                        </ul>
                    ...
                    <div class="dashboard-tab cart-wrapper p-5 bg-white rounded-lg shadow-xs">
                        <div class="row">
                            <div class="col-lg-4 offset-sm-4 text-center">
                                <figure class="avatar ml-auto mr-auto mb-0 mt-2 w100">
                                    <img src="https://cdn.pixabay.com/photo/2012/04/18/15/20/nurse-37322_1280.png" width="100px" height="100px">
                                </figure>
                                <h2 class="fw-900 font-sm text-grey-900 mt-3"> Hello {{ Auth::user()->name }} !</h2>
                    ...
                    <form action="{{ route('update-profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-lg-12 mb-3">
                                ...
                                <textarea class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Write your message..."
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyCOdKtT5fapH3_OfhV3HFeZjqFs4OfNIew&callback=mapinitialize"
                                ...
                                <script type="text/javascript">
                                    function mapinitialize() {
                                        ...
                                        var image = new google.maps.MarkerImage("images/map-marker.png", null, null, null, new google.maps.Size(50,
                                        50));
