                              ...
                              <div class="row cart-item-record">
                                 ...
                                 <div class="col-md-6 col-sm-4 col-xs-9">
                                    ...
                                    <div class="row item-qty-subtotal">
                                       <input type="hidden" name="sku" value="{{ $qsProd->sku }}"/>
                                       <div class="col-md-4 col-sm-4 col-xs-6"><span>Qtn :
                                          {{ $qsProd->prodData['quantity'] }}</span>
                                       </div>
                                       <input type="hidden" name="quantity" value="{{ $qsProd->prodData['quantity'] }}"/>
                                       <div class="col-md-8 col-sm-4 col-xs-6"><span>Subtotal
                                          :₹{{ $qsProd->prodData['denomination'] }}</span>
                                       </div>
                                       <input type="hidden" name="denomination" value="{{ $qsProd->prodData['denomination'] }}"/>
                                       <input type="hidden" name="numericCode" value="{{ $qsProd['currency']->numericCode }}"/>
                                    </div>
                                 </div>
                              </div>
