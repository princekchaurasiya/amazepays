	...
	<form method="POST" name="customerData" action="{{url('payment-process')}}">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="https://amazepay.toutle.in/payment/success"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="https://amazepay.toutle.in/payment/failed"/></td>
			 	</tr>
			 	<tr>
...
@push('scripts')
 ...
 <script language="javascript" type="text/javascript" src="{{URL::asset('js/json.js')}}"></script>
