                        ...
                        @foreach ($order as $orderItem)
                            @if ($orderItem->refno)
                                ...
                                <a href="#" class="order-link {{ !$isClickable ? 'disabled-link' : '' }}"
                                   data-order-id="{{ $orderItem->woohoo_order_id }}"
                                   ...
                                   style="{{ !$isClickable ? 'pointer-events: none;' : '' }}">
                                            ...
                                            <div class="card-body my-order-card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 ml-auto text-lg-right mt-3 mt-lg-0">
                                                        <h2>
                                                            <span class="{{ $orderItem->order_status == 'COMPLETE' ? 'text-success' : 'text-danger' }} font-weight-bold">
                                    ...
                                    <form action="{{ route('view-card-details') }}" method="post" id="orderForm" style="display: none;">
                                        @csrf
