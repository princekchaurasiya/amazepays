    ...
    <div class="banner-wrapper style1 bg-image-contain">
        ...
        <div id="desktopCarousel" class="carousel slide d-none d-md-block" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('images/merry-christmas.png') }}" alt="Amazepay Banner 1" class="d-block w-100">
                </div>

                <!-- Slide 2 -->
                <div class="carousel-item">
                    <img src="{{ asset('images/happy-new-year.png') }}" alt="Amazepay Banner 2" class="d-block w-100">
                </div>

                <!-- Slide 3 -->
                <div class="carousel-item">
                    <img src="{{ asset('images/meery-christmas-offer.png') }}" alt="Amazepay Banner 3"
                        class="d-block w-100">
                </div>
            </div>
        ...
        <div id="mobileCarousel" class="carousel slide d-block d-md-none" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <!-- Slide 1 -->
                <div class="carousel-item active">
                    <img src="{{ asset('images/merry-christmas-mobile.png') }}" alt="Amazepay Banner 1"
                        class="d-block w-100">
                </div>

                <!-- Slide 2 -->
                <div class="carousel-item">
                    <img src="{{ asset('images/happy-new-year-mobile.png') }}" alt="Amazepay Banner 2"
                        class="d-block w-100">
                </div>

                <!-- Slide 3 -->
                <div class="carousel-item">
                    <img src="{{ asset('images/meery-christmas-offer-mobile.png') }}" alt="Amazepay Banner 3"
                        class="d-block w-100">
                </div>
            </div>
                                    ...
                                    <div class="col-lg-3 col-6 home-page-image-padding">
                                        ...
                                        <div class="product-wrapper-image">
                                            ...
                                            <a href="{{ route('get-product-sku', ['slug' => $product->sku]) }}"
                                                ...
                                                <p class="single-image-wrapper"><img
                                                        src="{{ $product->images->small == null ? URL::asset('/images/no-image.png') : $product->images->small }}"
                                                        alt="product-image" class="w-100 mt-4 d-inline-block"></p>
                                            </a>
                                            <hr>
                                            <a href="{{ route('get-product-sku', ['slug' => $product->sku]) }}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="brand-slider owl-carousel owl-theme overflow-visible dot-none">
                        <div class="owl-items text-center"><img src="{{ URL::asset('/images/britannia-logo.png') }}"
                                alt="icon" class="w100 ml-auto mr-auto"></div>
                        <div class="owl-items text-center"><img src="{{ URL::asset('/images/GIFTS_GIGGLES.png') }}"
                                alt="icon" class="w100 ml-auto mr-auto"></div>
                        <div class="owl-items text-center"><img src="{{ URL::asset('/images/tomtom.png') }}"
                                alt="icon" class="w100 ml-auto mr-auto"></div>
                        <div class="owl-items text-center"><img src="{{ URL::asset('/images/cashfin.png') }}"
                                alt="icon" class="w100 ml-auto mr-auto"></div>
                        <div class="owl-items text-center"><img src="{{ URL::asset('/images/onstage.png') }}"
                                alt="icon" class="w100 ml-auto mr-auto"></div>
                    </div>
                </div>
            </div>
