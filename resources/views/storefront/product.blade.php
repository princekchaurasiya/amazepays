                                ...
                                <div class="col-lg-3">
                                    <div class="cardImage">
                                        ...
                                        <img class="img-fluid single-gift-image"
                                            src="{{ $productDetails['display_image_url'] ?? '' }}"
                                ...
                                <div class="col-lg-9" id="gifting-details">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @else
                                                <a href="#"
                                                    class="guest-checkout-modal-trigger form-control h60 bg-current float-right text-white text-center font-xss fw-500 border-0 p-0 mt-4 mb-4 w250 login-button-color"
                                                    data-guest-checkout>
                                                    Go to Checkout Page
                                                </a>
                                            @endif
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.guest-checkout-modal-trigger').on('click', function(e) {
                    e.preventDefault();
