        ...
        <div class="container">
            <div class="row">
                <form action="{{ route('storePayNowData-and-go-to-CheckoutPage', ['sku' => $getprdtDetails['sku']]) }}" method="POST" id="giftCardPageForm">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h6 class="mb-3 fw-600 font-xs mt-2" name="product_name"
                                ...
                                <div class="row card-form add-gift-cards d-none">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 text-center">
                                            ...
                                            <p class="font-xssss fw-500 text-grey-400 lh-26 mt-2">The e-gift card that you
                                        ...
                                        <div class="col-lg-4 col-md-4 text-center">
                                            ...
                                            <p class="font-xssss fw-500 text-grey-400 lh-26 mt-2">For better security of
                    ...
                    @if (\Auth::user())
                        <input type="submit"
                            class="form-control rounded-lg h60 float-right bg-current text-white text-center font-xss fw-500 border-2 border-0 p-0 mt-4 w100"
